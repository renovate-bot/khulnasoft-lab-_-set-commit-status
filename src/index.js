/// <reference types="khulnasoft" />
// @ts-check
const debug = require('debug')('set-github-status')
const { setGitHubCommitStatus, setCommonStatus } = require('./utils')
const pluralize = require('pluralize')

function getContext() {
  let context = 'Khulnasoft tests'
...
/**
 * @param {Khulnasoft.PluginEvents} on Function for registering event handlers
 */
